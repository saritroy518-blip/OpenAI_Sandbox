/* Forced cache-busting version badge v23 */
(function(){
  'use strict';
  const BUILD='2026.05.10.23';
  const LABEL='Analytics trends variance anomaly leakage';
  function styles(){
    if(document.getElementById('versionBadgeStylesV23'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV23';
