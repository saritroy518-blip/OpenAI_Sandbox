/* Forced cache-busting version badge v12 */
(function(){
  'use strict';
  const BUILD='2026.05.10.12';
  const LABEL='Setup wizard demo data templates';
  function styles(){
    if(document.getElementById('versionBadgeStylesV12'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV12';
