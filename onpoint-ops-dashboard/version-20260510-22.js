/* Forced cache-busting version badge v22 */
(function(){
  'use strict';
  const BUILD='2026.05.10.22';
  const LABEL='P&L Cost Bridge';
  function styles(){
    if(document.getElementById('versionBadgeStylesV22'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV22';
