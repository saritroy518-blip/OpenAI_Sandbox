/* Forced cache-busting version badge v25 */
(function(){
  'use strict';
  const BUILD='2026.05.10.25';
  const LABEL='Channel economics';
  function styles(){
    if(document.getElementById('versionBadgeStylesV25'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV25';
