/* Forced cache-busting version badge v15 */
(function(){
  'use strict';
  const BUILD='2026.05.10.15';
  const LABEL='Script queue Lift readiness QA self-test';
  function styles(){
    if(document.getElementById('versionBadgeStylesV15'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV15';
