/* Forced cache-busting version badge v8 */
(function(){
  'use strict';
  const BUILD='2026.05.10.8';
  const LABEL='Scenario cohorts playbooks heatmap mobile CEO';
  function styles(){
    if(document.getElementById('versionBadgeStylesV8'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV8';
