/* Forced cache-busting version badge v13 */
(function(){
  'use strict';
  const BUILD='2026.05.10.13';
  const LABEL='Role-based daily entry';
  function styles(){
    if(document.getElementById('versionBadgeStylesV13'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV13';
