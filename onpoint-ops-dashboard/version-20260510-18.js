/* Forced cache-busting version badge v18 */
(function(){
  'use strict';
  const BUILD='2026.05.10.18';
  const LABEL='Employee edit import and draft preservation';
  function styles(){
    if(document.getElementById('versionBadgeStylesV18'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV18';
