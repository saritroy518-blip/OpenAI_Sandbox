...
(function(){
  ...
  const GROUPS = [
    ...
    {name:'Finance', ids:['forecast','pnlcost','ledgers','finance','budget','scenario','close','backup','capitalpack','ownerecon','channelecon']},
    ...
    {name:'Reports', ids:['forecast','analytics','channelecon','history','dataqa','importqa','maturity','qatest']},
  ...
  const LABELS = {
    ...
    pnlcost:'P&L Cost Bridge', ledgers:'Finance + Forecast', finance:'Finance', budget:'Budget', scenario:'Scenario', close:'Monthly Close', backup:'Backup', capitalpack:'Capital Pack', ownerecon:'Owner Economics', channelecon:'Channel Economics',
