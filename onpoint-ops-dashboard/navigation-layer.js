...
(function(){
  ...
  const LABELS = {
    ...
    allocation:'Cost Allocation Engine', reconcile:'Reconciliation + Close', costledger:'Cost Attribution Ledger', pnlcost:'P&L Cost Bridge', ledgers:'Finance + Forecast', finance:'Finance', budget:'Budget', scenario:'Scenario', close:'Monthly Close', backup:'Backup', capitalpack:'Capital Pack', ownerecon:'Owner Economics', channelecon:'Channel Economics',
