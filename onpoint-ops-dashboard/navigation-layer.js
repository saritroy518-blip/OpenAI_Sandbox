...
(function(){
  ...
  const GROUPS = [
    ...
    {name:'Finance', ids:['forecast','pnlcost','ledgers','finance','budget','scenario','close','backup','capitalpack','ownerecon']},
    ...
    {name:'Reports', ids:['forecast','analytics','history','dataqa','importqa','maturity','qatest']},
