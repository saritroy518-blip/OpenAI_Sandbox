/* Forced cache-busting version badge v20 */
(function(){
  'use strict';
  const BUILD='2026.05.10.20';
  const LABEL='Stable employee add/edit modal';
  function styles(){
    if(document.getElementById('versionBadgeStylesV20'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV20';
