/* Forced cache-busting version badge v9 */
(function(){
  'use strict';
  const BUILD='2026.05.10.9';
  const LABEL='Profiles close capital pack partner scorecard';
  function styles(){
    if(document.getElementById('versionBadgeStylesV9'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV9';
