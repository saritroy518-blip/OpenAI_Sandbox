/* Forced cache-busting version badge v7 */
(function(){
  'use strict';
  const BUILD='2026.05.10.7';
  const LABEL='Import preview encrypted backups doctor tiers reports';
  function styles(){
    if(document.getElementById('versionBadgeStylesV7'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV7';
