/* Forced cache-busting version badge v17 */
(function(){
  'use strict';
  const BUILD='2026.05.10.17';
  const LABEL='Employee edit + form draft preservation';
  function styles(){
    if(document.getElementById('versionBadgeStylesV17'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV17';
