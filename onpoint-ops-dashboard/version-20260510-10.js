/* Forced cache-busting version badge v10 */
(function(){
  'use strict';
  const BUILD='2026.05.10.10';
  const LABEL='Control room search risks dictionary maturity admin';
  function styles(){
    if(document.getElementById('versionBadgeStylesV10'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV10';
