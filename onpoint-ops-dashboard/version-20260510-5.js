/* Forced cache-busting version badge */
(function(){
  'use strict';
  const BUILD='2026.05.10.5';
  const LABEL='Cache bust + operating layer';
  function styles(){
    if(document.getElementById('versionBadgeStylesV5'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV5';
