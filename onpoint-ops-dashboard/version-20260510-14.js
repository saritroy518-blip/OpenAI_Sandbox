/* Forced cache-busting version badge v14 */
(function(){
  'use strict';
  const BUILD='2026.05.10.14';
  const LABEL='Role mode favorites next actions help';
  function styles(){
    if(document.getElementById('versionBadgeStylesV14'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV14';
