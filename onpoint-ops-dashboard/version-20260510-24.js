/* Forced cache-busting version badge v24 */
(function(){
  'use strict';
  const BUILD='2026.05.10.24';
  const LABEL='Forecast engine';
  function styles(){
    if(document.getElementById('versionBadgeStylesV24'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV24';
