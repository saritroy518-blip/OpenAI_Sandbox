/* Forced cache-busting version badge v26 */
(function(){
  'use strict';
  const BUILD='2026.05.10.26';
  const LABEL='Cost attribution ledger';
  function styles(){
    if(document.getElementById('versionBadgeStylesV26'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV26';
