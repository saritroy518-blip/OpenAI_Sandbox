/* Forced cache-busting version badge v28 */
(function(){
  'use strict';
  const BUILD='2026.05.10.28';
  const LABEL='Cost allocation engine';
  function styles(){
    if(document.getElementById('versionBadgeStylesV28'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV28';
