/* Forced cache-busting version badge v6 */
(function(){
  'use strict';
  const BUILD='2026.05.10.6';
  const LABEL='Trends and CEO insights layer';
  function styles(){
    if(document.getElementById('versionBadgeStylesV6'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV6';
