/* Forced cache-busting version badge v21 */
(function(){
  'use strict';
  const BUILD='2026.05.10.21';
  const LABEL='Bulk Ops for scripts and actions';
  function styles(){
    if(document.getElementById('versionBadgeStylesV21'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV21';
