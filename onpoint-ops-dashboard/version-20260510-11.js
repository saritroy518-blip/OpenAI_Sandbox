/* Forced cache-busting version badge v11 */
(function(){
  'use strict';
  const BUILD='2026.05.10.11';
  const LABEL='Grouped navigation';
  function styles(){
    if(document.getElementById('versionBadgeStylesV11'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV11';
