/* Forced cache-busting version badge v27 */
(function(){
  'use strict';
  const BUILD='2026.05.10.27';
  const LABEL='Reconciliation and close control';
  function styles(){
    if(document.getElementById('versionBadgeStylesV27'))return;
    const s=document.createElement('style');
    s.id='versionBadgeStylesV27';
